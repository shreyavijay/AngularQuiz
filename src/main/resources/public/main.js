...
var AuthService = /** @class */ (function () {
    function AuthService(http) {
        this.http = http;
        this.signInUrl = '/v1/signIn';
        this.signOutUrl = '/v1/signOut';
    ...
    AuthService.prototype.logout = function (user) {
        return this.http.post(this.signOutUrl, user, this.httpOptions);
    };
...
var CandidateService = /** @class */ (function () {
    ...
    CandidateService.prototype.evaluateAssessement = function (candidate) {
        var developer = candidate && candidate.email ? this.getCandidate(candidate.email) : null;
        // TDB fixed
        var questions = developer.testName ? this.questionSrvc.getQuestions1(developer.testName) : null;
        ...
        if (proceedWithEvaluation) {
            questions.forEach(function (question) {
                ...
                var devResponseQuestionArray = developer.developerResponse.filter(function (devRes) { return devRes.questionId == question.questionId; });
...
var CreateTestComponent = /** @class */ (function () {
    ...
    CreateTestComponent.prototype.onSubmit = function () {
        ...
        this.testService.addTest(this.test).subscribe(function (response) { return _this.closeModal(); });
...
var LoginService = /** @class */ (function () {
    function LoginService(candidateSrvc, userSrvc, authSrvc, 
    ...
    LoginService.prototype.addSignedInUserToSession = function (user) {
...
module.exports = "<div class=\"form-container-wrapper\">\r\n    <div class=\"form-container\">\r\n        <div id=\"section_manageQuestions\" class=\"section\">\r\n            <h2 class=\"section-heading\"> {{testName}} </h2>\r\n            <button class=\"button save-button addQuestionButton\" (click)=\"addEditQuestion()\">Add New Question</button>\r\n            <app-modify-question *ngIf=\"addQuestion\" [action]=\"action\"\r\n                (closeModifyQuestionModal)=\"oncloseModal($event)\"></app-modify-question>\r\n\r\n            <div *ngFor=\"let question of questions; let i=index\" class=\"section accordion-wrapper\">\r\n                <button class=\"accordion\" id=\"questionButton\">{{question.question}}</button>\r\n                <div class=\"accordion-container\">\r\n                    <p class=\"answer\" *ngFor=\"let option of question.options; let j=index\">{{j+1}}. {{option.name}}</p>\r\n                    <div class=\"button-group-right\">\r\n                        <button class=\"button save-button\" (click)=\"addEditQuestion(question)\">Edit</button>\r\n                        <app-modify-question *ngIf=\"modifyQuestion\" [question]=\"question\" [action]=\"action\"\r\n                            (closeModifyQuestionModal)=\"oncloseModal($event)\"></app-modify-question>\r\n                        <!-- <button class=\"button save-button\" onclick=\"openModal(this)\">Delete hero</button> -->\r\n                        <button class=\"button save-button\" (click)=\"deleteQuestion(question)\">Delete hero</button>\r\n                        <div id=\"deleteModal\"></div>\r\n                    </div>\r\n                </div>\r\n            </div>\r\n\r\n\r\n        </div>\r\n    </div>\r\n    <br>\r\n    <br>\r\n    <br>\r\n    <br>\r\n    <br>\r\n    <br>\r\n    <br>\r\n    <br>\r\n    <br>\r\n    <br>\r\n    <br>\r\n    <br>\r\n\r\n</div>"
...
var ManageQuestionsComponent = /** @class */ (function () {
    ...
    ManageQuestionsComponent.prototype.ngOnInit = function () {
        ...
        this.route.queryParams.subscribe(function (params) {
            _this.action.testName = params['testName'];
            _this.action.testId = params['testId'];
            _this.questions = _this.loadQuestions();
        });
    };
    ManageQuestionsComponent.prototype.loadQuestions = function () {
        var _this = this;
        this.questionService.getQuestions(this.action.testId).subscribe(function (questions) {
            //Initialize accordion once the questions are loaded
            _this.accordionService.initializeAccordion();
    ...
    ManageQuestionsComponent.prototype.deleteQuestion = function (question) {
        this.questionService.deleteQuestion(question.testId, parseInt(question.questionId)).subscribe(function (response) { return console.log('Pritning response from Delete' + response); });
    };
...
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm5/forms.js");
/* harmony import */ var _questions_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../questions.service */ "./src/app/questions.service.ts");
/* harmony import */ var _questions__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../questions */ "./src/app/questions.ts");
/* harmony import */ var _action__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../action */ "./src/app/action.ts");
/* harmony import */ var _option__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../option */ "./src/app/option.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ModifyQuestionComponent = /** @class */ (function () {
    ...
    ModifyQuestionComponent.prototype.onDelete = function (optionIndex) {
    ...
    ModifyQuestionComponent.prototype.onSubmit = function () {
        ...
        console.log('Printing Answer ', this.questionForm.controls.aliases);
        // let answer: string[];
        // optionId and answer
        ...
        var newOptions = this.questionForm.value.aliases.filter(function (alias) { return alias.optionId == -1; });
        if (newOptions && newOptions.length > 0) {
            question.question = this.questionForm.value.question;
            newOptions.forEach(function (element) {
                var option = new _option__WEBPACK_IMPORTED_MODULE_5__["Option"]();
        ...
        if (question
            ...
            question.options.forEach(function (option) {
                ...
                //   }
                // });
                var index = _this.questionForm.value.aliases.findIndex(function (item) { return item.optionId == option.optionId && option.optionId > -1; });
                if (index > -1) {
                    // let optionForm = this.questionForm.value.aliases.get(index);
                    var optionForm = _this.questionForm.value.aliases[index];
            ...
            // });
            optionsToBeRemoved.forEach(function (optionsToBeRemoved) {
                var deleteIndex = question.options.findIndex(function (option) { return option.optionId == optionsToBeRemoved.optionId; });
                if (deleteIndex > -1) {
        ...
        this.questionsService.saveQuestion(question).subscribe(function (response) { return question = response; });
        this.closeModal();
    };
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", _action__WEBPACK_IMPORTED_MODULE_4__["Action"])
    ], ModifyQuestionComponent.prototype, "action", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", _questions__WEBPACK_IMPORTED_MODULE_3__["Question"])
    ], ModifyQuestionComponent.prototype, "question", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"])(),
        __metadata("design:type", Object)
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _questions__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./questions */ "./src/app/questions.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var QuestionsService = /** @class */ (function () {
    function QuestionsService(http) {
        this.http = http;
        this.questions = [];
        this.questionsInTestUrl = '/v1/user/allQuetionsInTest/';
        this.saveQuestionUrl = '/v1/user/createQuestion';
        this.deleteQuestionUrl = '/v1/user/deleteQuestion';
        this.httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_0__["HttpHeaders"]({ 'Content-Type': 'application/json' })
        };
    }
    QuestionsService.prototype.getQuestions1 = function (testName) {
    ...
    QuestionsService.prototype.getQuestions = function (testId) {
    ...
    QuestionsService.prototype.getQuestion = function (testName, questionId) {
        var questions = this.questions && this.questions.length > 0 ? this.questions.filter(function (question) {
            return question.testName.indexOf(testName) > -1 && question.questionId.indexOf(questionId) > -1;
        }) : null;
    ...
    QuestionsService.prototype.saveQuestion = function (question) {
        console.log('Save Question  ');
        return this.http.post(this.saveQuestionUrl, question, this.httpOptions);
    };
    QuestionsService.prototype.deleteQuestion = function (testId, questionId) {
    ...
    QuestionsService.prototype.getNewQuestion = function () {
        return new _questions__WEBPACK_IMPORTED_MODULE_2__["Question"](' ', ' ', [], ' ');
    };
    QuestionsService.prototype.editQuestion = function (modifiedQuestion) {
        var questions = this.questions.filter(function (question) {
            return modifiedQuestion && question.questionId == modifiedQuestion.questionId;
        });
...
var SignInComponent = /** @class */ (function () {
    function SignInComponent(fb, route, loginSrvc, authSrvc, userSrvc) {
        this.fb = fb;
        this.route = route;
        this.loginSrvc = loginSrvc;
        this.authSrvc = authSrvc;
    ...
    SignInComponent.prototype.onSubmit = function () {
        ...
        //   this.invalidCredentials = true;
        // }
        var authStatus = this.login();
        this.invalidCredentials = !authStatus;
    };
    SignInComponent.prototype.login = function () {
        var _this = this;
        var authStatus = false;
        var user = this.userSrvc.getNewUser();
        ...
        this.authSrvc.authenticate(user)
            ...
            if (response['firstName']) {
                authStatus = true;
                _this.loginSrvc.addSignedInUserToSession(response);
                _this.closeModal();
                _this.userSrvc.addUser(response);
                _this.route.navigateByUrl('/viewtests');
            }
            return authStatus;
        });
        return authStatus;
...
var SignUpComponent = /** @class */ (function () {
    ...
    SignUpComponent.prototype.onSubmit = function () {
        ...
        this.userService.signUpUser(this.user).subscribe(function (res) { return console.log('Print Response'); });
...
var TestService = /** @class */ (function () {
    function TestService(http, userSrvc) {
        this.http = http;
        this.userSrvc = userSrvc;
        this.getAllTestsUrl = '/v1/user/alltests';
        this.createTestUrl = '/v1/user/createTest';
        this.tests1 = [
    ...
    TestService.prototype.getTest = function (testName) {
        return this.tests1.length > 0 ? this.tests1.filter(function (test) { return test.name.indexOf(testName) > -1; })[0] : null;
    };
...
var UserService = /** @class */ (function () {
    ...
    UserService.prototype.getNewUser = function () {
        return new _user__WEBPACK_IMPORTED_MODULE_2__["User"]();
    };
    UserService.prototype.signUpUser = function (user) {
        console.log('Inside SignUp user');
        return this.http.post(this.backendUrl, user, this.httpOptions)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(function (user) { return console.log('print Hero'); }));
    };
...
var ViewTestComponent = /** @class */ (function () {
    ...
    ViewTestComponent.prototype.populateTests1 = function () {
        var _this = this;
        console.log('populate all tests');
        var tests = this.testService.getAllTests().subscribe(function (response) {
            _this.aliases.removeAt(0);
            //Remove initial element
            var index = _this.aliases.controls.findIndex(function (e) { return e.value == 'initial'; });
            console.log('ViewTestComponent', index, _this.tests$);
            if (index > -1) {
                _this.aliases.controls.splice(index, 1);
            }
            _this.tests$.forEach(function (element) {
    ...
    ViewTestComponent.prototype.populateTests = function () {
        ...
        console.log('populate all tests');
        var tests;
        this.testService.getAllTests().subscribe(function (response) {
            tests = response;
            _this.tests$ = Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["of"])(tests);
